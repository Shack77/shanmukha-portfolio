...
<div ckassName = "project-card"> 
  ...
  <div className="project-card">
          ...
          <a href="https://github.com/Shack77/Peptide-Classification" target="_blank" rel="noreferrer">GitHub</a>
        </div>
      ...
      <div className="project-card">
        ...
        <a href="#">GitHub</a>
          ...
          <a href="https://github.com/Shack77/lane-detection" target="_blank" rel="noreferrer">GitHub</a>
        </div>
        ...
        <div className="project-card">
          ...
          <a href="https://github.com/Shack77/Dice-Game" target="_blank" rel="noreferrer">GitHub</a>
        </div>
       ...
       <div className="project-card">
          ...
          <a href="https://github.com/Shack77/dynamic-pricing-aws-lambda" target="_blank" rel="noreferrer">GitHub</a>
        </div>
        ...
        <div className="project-card">
          ...
          <a href="https://github.com/Shack77/aws-chat-app" target="_blank" rel="noreferrer">GitHub</a>
        </div>
        ...
        <div className="project-card">
          ...
          <a href="https://github.com/Shack77/social-media-feed-ML" target="_blank" rel="noreferrer">GitHub</a>
        </div>
